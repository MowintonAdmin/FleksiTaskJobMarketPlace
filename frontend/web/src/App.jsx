    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed bottom-5 left-5 z-50 flex flex-col gap-3">
        ...
        <div className="relative flex items-center">
          <Link
            to="/help"
            className="w-14 h-14 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110 relative"
          ...
          {!user?.is_verified && (
            <Link
              to="/help"
              className="ml-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-3.5 py-1.5 rounded-xl shadow-lg text-xs font-bold whitespace-nowrap animate-bounce flex items-center gap-1 hover:brightness-110 transition-all cursor-pointer relative after:content-[''] after:absolute after:top-1/2 after:-left-2 after:-translate-y-1/2 after:border-8 after:border-transparent after:border-r-indigo-600"
            >
              <span>💬 Click me!</span>
            </Link>
          )}
        ...
        <a
          ...
          className="w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110"
