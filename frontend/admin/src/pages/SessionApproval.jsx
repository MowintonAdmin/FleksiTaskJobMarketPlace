              ...
              <div className="p-5 space-y-4">
                ...
                {s.task_status === 'cancelled' && (
                  <div className="mt-3 bg-red-50 border border-red-200 rounded-lg px-3 py-2 flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-red-700">Task Cancelled by Admin</p>
                      {s.proof_notes && <p className="text-xs text-red-600 mt-0.5">{s.proof_notes}</p>}
                    </div>
                  </div>
                )}
                {s.is_adjusted && (
                  <div className="mt-3 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 flex items-center gap-2">
                    ...
                    <p className="text-xs font-semibold text-amber-700">Earnings have been manually adjusted</p>
                  </div>
                )}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                </div>
