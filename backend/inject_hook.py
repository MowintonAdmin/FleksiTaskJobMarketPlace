...
root = r'C:\Users\Syed Emio\Desktop\FleksiTaskJobMarketPlace\frontend\admin\src\pages'
for f in sorted(os.listdir(root)):
    if not f.endswith('.jsx') or f == 'AdminLogin.jsx':
        continue
    ...
    # Find the initial load useEffect and add useAutoRefresh call after it
    lines = content.split('\n')
    new_lines = []
    hook_added = False
    for line in lines:
